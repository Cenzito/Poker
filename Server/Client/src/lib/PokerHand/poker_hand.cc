...
std::vector<int> PokerHand::get_score() // for each hand, we create a score, which will be used to compare the hands
{
    ...
    else if(has_four_of_a_kind()==true)
    {
        ...
        for(int i=14; i>1; i--)
        {
            if(ranks[i]>=1 && i!=max)
            {
                score[2]=i;    //the second tie breaker is the highest rank of a card that is not from the quatruplet
                break;
            }
        }
    ...
    else if(has_full_house()==true)
    {
        ...
        for(int i=14; i>1; i--)
        {
            if(ranks[i]>=2 && i!=max)
            {
                score[2]=i;    //the second tie breaker is the highest rank of a card that is not from the triplet
                break;
            }
        }
    }
    ...
    else if(has_three_of_a_kind()==true)
    {
        ...
        for(int i=14; i>1; i--)
        {
            if(ranks[i]==3)
            {
                score[1]=i;    //the tie breaker is the rank of the triplet
                break;
            }
        }
        for (int i=14; i>1; i--)
        {
            if(ranks[i]>=1 && i!=score[1])
            {
                score[2]=i;    //the second tie breaker is the highest rank of a card that is not from the triplet
                break;
            }
        ...
        for (int i=14; i>1; i--)
        {
            if(ranks[i]>=1 && i!=score[1] && i!=score[2])
            {
                score[3]=i;    //the third tie breaker is the highest rank of a card that is not from the triplet or the pair
                break;
            }
        }
    ...
    else if(has_two_pairs()==true)
    {
        ...
        for (int i=14; i>1; i--)
        {
            if(ranks[i]==2)
            {
                score[1]=i;    //the first tie breaker is the rank of the first pair
                break;
            }
        }
        for (int i=14; i>1; i--)
        {
            if(ranks[i]==2 && i!=score[1])
            {
                score[2]=i;    //the second tie breaker is the rank of the second pair
                break;
            }
        }
        for (int i=14; i>1; i--)
        {
            if(ranks[i]>=1 && i!=score[1] && i!=score[2])
            {
                score[3]=i;    //the third tie breaker is the highest rank of a card that is not from the pairs
                break;
            }
        }
    ...
    else if(has_pair()==true)
    {
        ...
        for (int i=14; i>1; i--)
        {
            if(ranks[i]==2)
            {
                score[1]=i;    //the first tie breaker is the rank of the pair
                break;
            }
        }
        for (int i=14; i>1; i--)
        {
            if(ranks[i]>=1 && i!=score[1])
            {
                score[2]=i;    //the second tie breaker is the highest rank of a card that is not from the pair
                break;
            }
        }
        for (int i=14; i>1; i--)
        {
            if(ranks[i]>=1 && i!=score[1] && i!=score[2])
            {
                score[3]=i;    //the third tie breaker is the highest rank of a card that is not from the pair or the first tie breaker
                break;
            }
        }
        for (int i=14; i>1; i--)
        {
            if(ranks[i]>=1 && i!=score[1] && i!=score[2] && i!=score[3])
            {
                score[4]=i;    //the fourth tie breaker is the highest rank of a card that is not from the pair or the first or second tie breaker
                break;
            }
        }
    }
